...
func (g *GiteaCompatibleSource) GetLatestRelease(ctx context.Context, projectPath string, opts ReleaseOptions) (*Release, error) {
...
func (g *GiteaCompatibleSource) getLatestStableRelease(ctx context.Context, projectPath string) (*Release, error) {
...
func (g *GiteaCompatibleSource) getLatestReleaseIncludingPrereleases(ctx context.Context, projectPath string) (*Release, error) {
	...
	endpoint := fmt.Sprintf("%s/api/v1/repos/%s/%s/releases", g.baseURL, owner, repo)
